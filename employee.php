...
<div class="nxl-content">
                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#employee-model">
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#employee-model-update" onclick="getdata(<?=$c->id?>)">
 ...
 <?php include "modals/add_employee.php"; ?>
 ...
 <script>
        function getdata(id){
            ...
            data: {table:`employee`,id:id,action:'getdata'},
        ...
        success: function(response)
        {
            ...
            if(confirm("Are you Sure To Delete [" +res[0].name +"]")){
                $.ajax({
                    type: "POST",
                    url: 'includes/ajax.php',
                    data: {table:`employee`,id:id,action:'deletedata',location:"employee.php"},
                    success: function(response)
                    {
                        var res = JSON.parse(response);
