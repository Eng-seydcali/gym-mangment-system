...
if(isset($_POST["add_expense_type"])){
    ...
    insert($data,"expense_type");
}

if(isset($_POST['upd_expense_type'])){
    $data = array(
        "id" => $_POST["id"],
        "name" => $_POST['name']
    );

    update($data,"expense_type");
}
...
<div class="nxl-content">
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Expense Type</h5>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#expense_type-model">
                                <i class="feather-plus me-2"></i>
                                <span>Create expense_type</span>
                            </button>
                        </div>
                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="javascript:void(0);" class="fw-bold d-block">
                                                <span class="text-truncate-1-line">Total expense_types</span>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="javascript:void(0);" class="fw-bold d-block">
                                                <span class="text-truncate-1-line">Active expense_types</span>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="javascript:void(0);" class="fw-bold d-block">
                                                <span class="text-truncate-1-line">New expense_types</span>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <a href="javascript:void(0);" class="fw-bold d-block">
                                                <span class="text-truncate-1-line">Inactive expense_types</span>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="customerList">
                                        ...
                                        <tbody>
                                            <?php 
                                                $num = 0;
                                                foreach(readAll("*","expense_type") as $c) {?>
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#expense_type-model-update" onclick="getdata(<?=$c->id?>)">
 ...
 <?php include "modals/add_expense_type.php"; ?>
 ...
 <script>
        ...
        data: {table:`expense_type`,id:id,action:'getdata'},
        ...
        success: function(response)
        {
            ...
            if(confirm("Are you Sure To Delete [" +res[0].name +"]")){
                $.ajax({
                    type: "POST",
                    url: 'includes/ajax.php',
                    data: {table:`expense_type`,id:id,action:'deletedata',location:"expense_type.php"},
                    success: function(response)
                    {
                        var res = JSON.parse(response);
