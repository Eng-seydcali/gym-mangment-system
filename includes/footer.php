   ...
   <!--! ================================================================ !-->
    ...
    function getCurrentDateTime() {
        ...
        const month = String(now.getMonth() + 1).padStart(2, '0'); // Get the month (MM), pad with 0 if necessary
        const day = String(now.getDate()).padStart(2, '0'); // Get the day of the month (DD), pad with 0 if necessary
        const hour = String(now.getHours()).padStart(2, '0'); // Get the hour (HH), pad with 0 if necessary
        const minute = String(now.getMinutes()).padStart(2, '0'); // Get the minutes (MM), pad with 0 if necessary
        const second = String(now.getSeconds()).padStart(2, '0'); // Get the seconds (SS), pad with 0 if necessary
